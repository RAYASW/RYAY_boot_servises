...
{
    $data = getPosts();
     $insert_Query = "INSERT INTO `vacation_form`(`username`, `password`) VALUES ('".$data[1]."','".$data[2]."')";
    try{
    ...
    <div class="container" align="Center">
        <h2>
          ...
          <div class="row mar-bot40">
            <td>
            <form action="Vacation_req.php" method="post" >
                User name <input type="text" name="username" value="Headq\"><br><br>
